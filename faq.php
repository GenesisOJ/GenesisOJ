 <!DOCTYPE html>
  ...
  <center>
	...
	如果您可以为我们捐款,我们将衷心感谢您！下面是捐款码，您扫码即可为我们投食。特别提醒：在捐赠信息中一定注明您在本网站的用户名<br>
	<img src="/feed.jpg"  alt="给我们投食" /><br>
	如您对捐赠有疑问，请发送邮件至flamesheart@qq.com,谢谢！
	</p>
	<h3>2.系统简述</h3>
	<p> 测评配置:为Hustoj的测评机的二次开发，配置与Hust相同<br>
		操作系统:Ubuntu 16.04<br></p>
	<h3>3.网站相关事宜<h3>
	<h4>3.1 开发成员</h4>
	<p>主要开发:flamesheart, jyb666, pcoaoy<br>
	   辅助开发:cbj等
	</p>
	<h4>3.2管理人员</h4>
	<p>flamesheart, jyb666, jiayouba, ytha等</p>
	<h4>3.3其他事宜</h4>
	<p>因个人编写水平有限，网站维护、界面设计、网站安全等部分功能开发尚不成熟，如有疑问或建议，请联系通过站长邮箱进行联系<br>
